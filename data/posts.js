...
window.posts = [
{
  ...
  {
    id: 'why-i-write-a-blog',
    title: '为什么我要重新开始写博客',
    date: '2026-09-12',
    tags: ['随笔', '写作'],
    excerpt: '社交平台的碎片表达养成了我很差的思考习惯。重新写博客，是想把那些半成品的想法逼成一个完整的东西。',
    cover: '',
    readingTime: 5,
    content: `
      <p>前几天整理旧硬盘，翻出 2019 年写的一批草稿。十几篇文章，全部停在开头两三百字。当时我总觉得自己还没想清楚，等想清楚了再写——结果就是永远没想清楚。</p>

      <h2>碎片表达的问题</h2>
      <p>社交平台把表达压缩到了几百字以内，这本身不是坏事。问题在于，当表达变得足够廉价，人就会放弃把一件事讲完整的能力。我发现自己的思考开始变得像短句的集合，论点很多，论据很少，而且随时可以被下一条内容冲掉。</p>

      <blockquote>写作不是思考的记录，写作就是思考本身。</blockquote>

      <p>这句话被引用得太多了，但真正动手写的时候才明白它的意思。当你必须把一句判断落到纸面上，你会立刻发现中间缺了多少环节。</p>

      <h2>这次打算怎么做</h2>
      <ul>
        <li><strong>不强求完整。</strong>允许自己写出半成品，但必须是诚实的半成品——哪里没想清楚就明说没想清楚。</li>
        <li><strong>不追热点。</strong>这个站上不会有"A 股暴涨暴跌的背后"这类标题。</li>
        <li><strong>固定频率。</strong>两周一篇，写在日历里，到时间就得交。</li>
      </ul>

      <h2>关于这个站的技术选择</h2>
      <p>这个博客是手写 HTML、CSS 和原生 JavaScript 搭起来的，没用任何框架。原因很简单：我想让"写作"这件事的摩擦力尽可能小。打开编辑器，写一段 HTML，存盘，推送，就发布了。</p>
      <p>整站没有一个构建步骤，没有 <code>node_modules</code>，没有任何依赖需要在半年后升级。我希望三年后回来还能直接用浏览器打开它。</p>

      <p>就是这样。第一篇文章写完了，比预想的容易。</p>
    `
  },
